...
public class Pizza {
	//constants for pizza name and size
	public static final int DELUX_IDLI_VEG_REGULAR=235;
	public static final int DELUX_IDLI_VEG_MEDIUM=450;
	public static final int DELUX_IDLI_VEG_LARGE=695;
	public static final int FARMHOUSE_MEXICAN_RAGULAR=215;
	public static final int PEPPY_RAGULAR=335;
	public static final int FARMHOUSE_MEXICAN_MEDIUM=395;
	public static final int FARMHOUSE_MEXICAN_LARGE=595;
	//constants for pizza crusts
	public static final int NEW_HAND_CLASSIC_CRUST=215;
	public static final int CHEESE_CRUST=290;
	public static final int FRESH_CRUST=245;
	public static final int WHEAT_CRUST=500;
	public static final int VEG_TOPPING=60;
	public static final int NON_VEG_TOPPING=75;

	// constant array of all varieties of pizza
	public static final String[] PIZZAS= {" ","delux veggie","veg extravaganza","idli tandoori paneer","farmhouse","peppy paneer","mexican green wave"};
	//constant array of all varieties of crusts
	public static final String[] CRUSTS= {" ","new hand tosted","cheese burst","fresh pan pizza","classic hand tosted","wheat thin crust"};
	//constant array of all varieties of veg toppings
	public static final String[] VEGTOPPINGS= {" ","jalapeno","black olives","onion","red peparenka","fresh tommato",
			"golden corn","crisp capsicum","paneer","grilled mashroom","paneer tikka"};
	//constant array of all varieities of non veg toppings
	public static final String[] NONVEGTOPPINGS= {" ","pepper barbeque chiken","peri peri chiken","grilled chiken rasher",
